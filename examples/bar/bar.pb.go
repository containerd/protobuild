...
func (c *barClient) Do(ctx context.Context, in *DoRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	out := new(google_protobuf.Empty)
	err := grpc.Invoke(ctx, "/protobuild.example.bar.Bar/Do", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _Bar_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/stevvooe/protobuild/examples/bar/bar.proto",
}

func init() {
	proto.RegisterFile("github.com/stevvooe/protobuild/examples/bar/bar.proto", fileDescriptor0)
}
...
var fileDescriptor0 = []byte{
	...
	0xc8, 0x49, 0x2d, 0xd6, 0x4f, 0x4a, 0x2c, 0x02, 0x61, 0x3d, 0xb0, 0x9c, 0x90, 0x18, 0x42, 0x89,
	0x1e, 0x54, 0x89, 0x5e, 0x52, 0x62, 0x91, 0x94, 0x74, 0x7a, 0x7e, 0x7e, 0x7a, 0x0e, 0xdc, 0x84,
	...
	0x46, 0x6e, 0x5c, 0xcc, 0x4e, 0x89, 0x45, 0x42, 0xf6, 0x5c, 0x4c, 0x2e, 0xf9, 0x42, 0x8a, 0x7a,
	0xd8, 0x9d, 0xaa, 0x07, 0xb7, 0x49, 0x4a, 0x0c, 0xc3, 0x58, 0x57, 0x90, 0xab, 0x9d, 0x8c, 0xa2,
	0x0c, 0x48, 0x09, 0x1d, 0xeb, 0xa4, 0xc4, 0xa2, 0x24, 0x36, 0xb0, 0xac, 0x31, 0x20, 0x00, 0x00,
	0xff, 0xff, 0x30, 0x29, 0xdd, 0xf7, 0x58, 0x01, 0x00, 0x00,
}
