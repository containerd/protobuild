...
func (*DoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_818fea20c208cd0e, []int{0}
}
...
func init() {
	proto.RegisterFile("github.com/stevvooe/protobuild/examples/bar/bar.proto", fileDescriptor_818fea20c208cd0e)
}

var fileDescriptor_818fea20c208cd0e = []byte{
