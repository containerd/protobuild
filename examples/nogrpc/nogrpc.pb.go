...
func (*Thing) Descriptor() ([]byte, []int) {
	return fileDescriptor_d5d962b3cbb01fd4, []int{0}
}
...
func (m *Thing) GetTimestamp() *types.Timestamp {
	if m != nil {
		return m.Timestamp
	}
	return nil
...
func init() {
	proto.RegisterFile("github.com/stevvooe/protobuild/examples/nogrpc/nogrpc.proto", fileDescriptor_d5d962b3cbb01fd4)
}

var fileDescriptor_d5d962b3cbb01fd4 = []byte{
