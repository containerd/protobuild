...
func (*DoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d680d085ff9483cd, []int{0}
}
...
func init() {
	proto.RegisterFile("github.com/stevvooe/protobuild/examples/foo/foo.proto", fileDescriptor_d680d085ff9483cd)
}

var fileDescriptor_d680d085ff9483cd = []byte{
	...
	,
}
...
func (c *fooClient) Do(ctx context.Context, in *DoRequest, opts ...grpc.CallOption) (*types.Empty, error) {
	out := new(types.Empty)
...
func (*UnimplementedFooServer) Do(ctx context.Context, req *DoRequest) (*types.Empty, error) {
...
var _Foo_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/stevvooe/protobuild/examples/foo/foo.proto",
}
