...
func (c *fooClient) Do(ctx context.Context, in *DoRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	out := new(google_protobuf.Empty)
	err := grpc.Invoke(ctx, "/protobuild.example.foo.Foo/Do", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() {
	proto.RegisterFile("github.com/stevvooe/protobuild/examples/foo/foo.proto", fileDescriptor0)
}
